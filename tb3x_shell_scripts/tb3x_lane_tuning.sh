...
echo //////////////// raspi_camera ///////////////
echo /////////////////////////////////////////////
ssh tb304@192.168.1.104 'source /opt/ros/kinetic/setup.bash && source ~/catkin_ws/devel/setup.bash && export ROS_MASTER_URI=http://192.168.1.122:11311 && export ROS_HOSTNAME=192.168.1.104 && ~/catkin_ws/src/tb3_shell_scripts/./raspi_camera.sh' &
echo ...please wait for a while
sleep 10
echo done
...
echo /////////////////////////////////////////////
ssh tb304@192.168.1.104 'source /opt/ros/kinetic/setup.bash && source ~/catkin_ws/devel/setup.bash && export ROS_MASTER_URI=http://192.168.1.122:11311 && export ROS_HOSTNAME=192.168.1.104 && ~/catkin_ws/src/tb3_shell_scripts/./instrinsic_camera_action.sh' &
echo ...please wait for a while
sleep 10
echo done
