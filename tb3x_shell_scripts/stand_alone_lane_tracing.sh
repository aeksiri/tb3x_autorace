...
#ssh tb304@192.168.1.104 -X 'source /opt/ros/kinetic/setup.bash && source ~/catkin_ws/devel/setup.bash && export ROS_MASTER_URI=http://192.168.1.104:11311 && export ROS_HOSTNAME=192.168.1.104 && ~/catkin_ws/src/tb3_shell_scripts/./extrinsic_camera_calib.sh' &
ssh tb304@192.168.1.104 -X 'source /opt/ros/kinetic/setup.bash && source ~/catkin_ws/devel/setup.bash && export ROS_MASTER_URI=http://192.168.1.104:11311 && export ROS_HOSTNAME=192.168.1.104 && ~/catkin_ws/src/tb3_shell_scripts/./extrinsic_camera_action.sh' &
echo ...please wait for a while
sleep 10
echo done
...
#ssh tb304@192.168.1.104 -X 'source /opt/ros/kinetic/setup.bash && source ~/catkin_ws/devel/setup.bash && export ROS_MASTER_URI=http://192.168.1.104:11311 && export ROS_HOSTNAME=192.168.1.104 && ~/catkin_ws/src/tb3_shell_scripts/./detect_lane_tuning.sh' &
echo ...please wait for a while
sleep 10
echo done
